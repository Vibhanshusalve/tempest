...
async def topgg():
    ...
    webhook_data = {
        ...
        "embeds": [
            {
                "description": "**[Voted Tempest](https://top.gg/bot/1144179659735572640)**\n💖 Thank you for voting for Tempest on Top.gg, your support means everything to us!\n",
                "fields": [
                ...
                "footer": {
                    "text": f"Voter ID: {user_id} | Tempest Federation™ | {footer_time}",
